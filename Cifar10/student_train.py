...
if __name__ == '__main__':
  ...
  parser.add_argument('--teacher_model',default="ResNet18",help="default ResNet18, other options are VGG, ResNet50, ResNet101, MobileNet, MobileNetV2, ResNeXt29, DenseNet, PreActResNet18, DPN92, SENet18, EfficientNetB0, GoogLeNet, ShuffleNetG2, ShuffleNetV2,")
  ...
  teacher_net = get_model(args.teacher_model)
  ...
  #todo: jsonears
  os.mkdir("distillation")
  os.chdir("distillation")

  student_net = linear_model(1000)
  ...
  writer = SummaryWriter("Distillation")

  criterion = nn.CrossEntropyLoss()
  #optimizer = optim.SGD(net.parameters(), lr=args.lr, momentum=0.9, weight_decay=5e-4)
  optimizer = optim.Adam(teacher_net.parameters(), lr=args.lr)
