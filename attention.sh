...
#python feat_distillation.py --distillation=nst_gauss --layer=2 --train_batch_size=64 --test_batch_size=64
#python feat_distillation.py --distillation=nst_gauss --layer=3 --train_batch_size=64 --test_batch_size=64
#python feat_distillation.py --distillation=nst_gauss --layer=4 --train_batch_size=64 --test_batch_size=64
#python feat_distillation.py --distillation=nst_gauss --layer=5 --train_batch_size=64 --test_batch_size=64
