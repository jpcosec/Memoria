...
global_titles={"test_acc":"Exactitud en validacion",
               'test/acc':"Exactitud en validacion",
               'test/wall_time':"Tiempo de entrenamiento [s]",
                "test_teacher/acc":"Exactitud de red tutora en validacion",
                "test_loss":"Perdida en entrenamiento",
                "test_eval":"Evalucacion en entrenamiento",
                "train_acc":"Exactitud en entrenamiento",
                "train_teacher/acc":"Exactitud de red tutora en entrenamiento",
                ...
                "delta_teacher":"Diferencia de exactitud con red tutora en entrenamiento",
                "delta_student":"Diferencia de exactitud con red estudiante (CE) en entrenamiento",
                "test/train":"Ratio de exactitud en entrenamiento y validacion",
                "noise":"Potencia de Ruido",
                "loss_conv":"Epoca de de minima perdida alcanzada",
                "acc_conv":"Epoca de maximo exactitud alcanzado",
                "max":"Exactitud en validacion",
                "epochs":'Epoca',
